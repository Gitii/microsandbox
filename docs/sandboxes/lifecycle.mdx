...
Local detached or reconnected handles require recorded clean run termination and
an exited VM process; a `Stopped` row alone is insufficient. Cloud stop observes
