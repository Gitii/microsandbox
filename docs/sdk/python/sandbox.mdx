...
<div className="msb-params">
  <div className="msb-param">
    ...
    <div className="msb-param-desc">Graceful shutdown deadline in seconds. <code>None</code> uses the 150-second default. Expiry raises an error; <code>0</code> is rejected.</div>
  </div>
</div>
