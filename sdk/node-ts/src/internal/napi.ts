...
export interface NativeBindings {
  readonly diskCreate: (path: string, sizeBytes: bigint) => import("../disk.js").DiskInfo;
  readonly diskInspect: (path: string) => import("../disk.js").DiskInfo;
  readonly diskGrowCopy: (source: string, destination: string, sizeBytes: bigint) => import("../disk.js").DiskInfo;
