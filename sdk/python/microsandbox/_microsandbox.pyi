...
class Disk:
    """Synchronous local maintenance; stop/detach and hold a lifecycle lock."""
    @staticmethod
    def create(path: str, size_bytes: int) -> DiskInfo: ...
    @staticmethod
    def inspect(path: str) -> DiskInfo: ...
    @staticmethod
    def grow_copy(source: str, destination: str, size_bytes: int) -> DiskInfo: ...
